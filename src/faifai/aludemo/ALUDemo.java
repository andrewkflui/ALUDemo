...
public class ALUDemo extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    demoPanelALU1 = new faifai.aludemo.DemoPanelALU();
    ...
    getContentPane().add(demoPanelALU1, gridBagConstraints);
    ...
    private void clockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clockActionPerformed
      demoPanelALU1.clockSignalReceived();
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      ...
      public void run() {
        new ALUDemo().setVisible(true);
      }
    });
  }
  // Variables declaration - do not modify//GEN-BEGIN:variables
  private faifai.aludemo.DemoPanelALU demoPanelALU1;
