...
public class Register extends javax.swing.JPanel implements Component {
  ...
  public Register() {
    ...
    theCore.addPort(new Port(theNumber, "REG INOUT", Port.PORT_INOUT));
    int range[] = {Core.MODE_DEC, Core.MODE_HEX};
    theCore.setRepresentationRange(range);
    theCore.setRepresentationMode(Core.MODE_HEX);
    updateDisplay();
  }
  ...
  public void updateDisplay() {
    ...
    jButton2.setText(thePort.getStatusString());
    if (thePort.getStatus() == Port.STATUS_READ) {
      jButton2.setBackground(new Color(204, 255, 102));
    } else if (thePort.getStatus() == Port.STATUS_WRITE) {
  ...
  private void initComponents() {
    ...
    jTextField1.setFont(new java.awt.Font("Arial", 1, 10));
